...
const Listcareerlevel = () => {
  const navigate = useNavigate();
  const navigateTocareerlevel = () => {
    navigate("/Addcareerlevel");
  };
        ...
        <div className="Tabs_content text-start p-4">
          <div className="d-flex justify-content-between pb-3">
            <div className="d-flex">
              <FaIcons.FaGraduationCap className="fs-3 me-3" />
              <h4>All Career-levels</h4>
            </div>
            <Button
              className="Btn_color d-flex align-content-center py-2"
              onClick={navigateTocareerlevel}
            >
          ...
          <div className="Tabs_header d-flex justify-content-between py-4">
            ...
            <div>
              <Form>
                <FormControl
                  type="text"
                  placeholder="Search for Career-level ..."
                />
              </Form>
            </div>
          </div>
            ...
            <Table striped bordered hover>
              <thead>
                <tr>
                  ...
                  <th>
                    <FormControl type="text" placeholder="Career-level" />
                  </th>
