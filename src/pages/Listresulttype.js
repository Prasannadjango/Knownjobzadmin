...
const Listresulttype = () => {
  ...
  const navigateToresulttypes = () => {
    navigate("/Addresulttypes");
  };
          ...
          <div className="Tabs_header d-flex justify-content-between py-4">
            ...
            <div>
              <Form>
                <FormControl
                  type="text"
                  placeholder="Search for  Result-types ..."
                />
              </Form>
            </div>
          </div>
