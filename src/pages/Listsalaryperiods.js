        ...
        <div className="Tabs_content text-start p-4">
          <div className="d-flex justify-content-between pb-3">
            <div className="d-flex">
              <FaIcons.FaMoneyBillAlt  className="fs-3 me-3" />
              <h4>All salary-periods </h4>
            </div>
            <Button
          ...
          <div className="Tabs_header d-flex justify-content-between py-4">
            ...
            <div>
              <Form>
                <FormControl
                  type="text"
                  placeholder="Search for salary-period ..."
                />
              </Form>
            </div>
          </div>
            ...
            <Table striped bordered hover>
              <thead>
                <tr>
                  ...
                  <th >
                  <FormControl type="text" placeholder=" salary-period" />
                  </th>
                  <th className="col-2">
                    <Form.Select aria-label="Default select example">
...
export default Listsalaryperiods ;
