...
const Listmaritialstatus = () => {
  const navigate = useNavigate();
  const navigateTomaritialstatus = () => {
    navigate("/Addmaritalstatus");
  };
        ...
        <div className="Tabs_content text-start p-4">
          <div className="d-flex justify-content-between pb-3">
            <div className="d-flex">
              <FaIcons.FaVenusMars className="fs-3 me-3" />
              <h4>All Marital-status </h4>
            </div>
            <Button
              className="Btn_color d-flex align-content-center py-2"
              onClick={navigateTomaritialstatus}
            >
            ...
            <Table striped bordered hover>
              <thead>
                <tr>
                  ...
                  <th >
                  <FormControl type="text" placeholder=" Marital-status " />
                  </th>
                  <th className="col-2">
                    <Form.Select aria-label="Default select example">
...
export default Listmaritialstatus ;
