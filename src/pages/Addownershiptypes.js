      ...
      <div className="Tabs_container">
        <div className="Tabs_content text-start p-4">
          ...
          <Form className="Adminuser_form col-8 py-4">
            ...
            <label className="fs-6">Owner ship-type:</label>
            <FormControl type="text" placeholder="Ownershiptype"  className="py-2 mb-3"/>
...
export default Addownershiptype;
