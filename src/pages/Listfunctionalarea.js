...
const Listfunctionalarea = () => {
  const navigate = useNavigate();
  const navigateTofunctionalarea = () => {
    navigate("/Addfunctionalarea");
  };
        ...
        <div className="Tabs_content text-start p-4">
          <div className="d-flex justify-content-between pb-3">
            <div className="d-flex">
              ...
              <h4>All Functional Area</h4>
            </div>
            <Button
              className="Btn_color d-flex align-content-center py-2"
              onClick={navigateTofunctionalarea}
            >
          ...
          <div className="Tabs_header d-flex justify-content-between py-4">
            ...
            <div>
              <Form>
                <FormControl
                  type="text"
                  placeholder="Search for Functional-area ..."
                />
              </Form>
            </div>
          </div>
            ...
            <Table striped bordered hover>
              <thead>
                <tr>
                  ...
                  <th >
                  <FormControl type="text" placeholder="Functional-area" />
                  </th>
                  <th className="col-2">
                    <Form.Select aria-label="Default select example">
...
export default Listfunctionalarea;
