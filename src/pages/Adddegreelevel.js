...
function Adddegreelevel() {
  return (
    <>
      <div className="Tabs_container">
        <div className="Tabs_content text-start p-4">
          <h4>Add New Degreelevel</h4>
          <Form className="Adminuser_form col-8 py-4">
            ...
            <label className="fs-6">Degreelevel:</label>
            <FormControl type="text" placeholder="Degreelevel"  className="py-2 mb-3"/>
