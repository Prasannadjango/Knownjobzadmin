...
const Listjobshift = () => {
  ...
  const navigateTojobshift = () => {
    navigate("/Addjobshift");
  };
        ...
        <div className="Tabs_content text-start p-4">
          <div className="d-flex justify-content-between pb-3">
            <div className="d-flex">
              <FaIcons.FaUserClock className="fs-3 me-3" />
              <h4>All Job-shift</h4>
            </div>
            <Button
              className="Btn_color d-flex align-content-center py-2"
              onClick={navigateTojobshift}
            >
          ...
          <div className="Tabs_header d-flex justify-content-between py-4">
            ...
            <div>
              <Form>
                <FormControl
                  type="text"
                  placeholder="Search for jobshift..."
                />
              </Form>
            </div>
          </div>
            ...
            <Table striped bordered hover>
              <thead>
                <tr>
                  ...
                  <th >
                  <FormControl type="text" placeholder="Job-shift" />
                  </th>
                  <th className="col-2">
                    <Form.Select aria-label="Default select example">
