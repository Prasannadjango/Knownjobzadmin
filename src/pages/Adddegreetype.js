...
function Adddegreetype() {
  return (
    <>
      <div className="Tabs_container">
        <div className="Tabs_content text-start p-4">
          <h4>Add New Degree-type</h4>
          <Form className="Adminuser_form col-8 py-4">
            ...
            <label className="fs-6">Degree-level:</label>
            <Form.Select
              aria-label="Default select example"
              className="py-2 mb-3"
            >
            ...
            <label className="fs-6">Degree-type:</label>
            <FormControl type="text" placeholder="degreetype"  className="py-2 mb-3"/>
