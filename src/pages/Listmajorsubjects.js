...
const Listmajorsubjects = () => {
  const navigate = useNavigate();
  const navigateTomajorsubject = () => {
    navigate("/Addmajorsubjects");
  };
          ...
          <div className="Tabs_header d-flex justify-content-between py-4">
            ...
            <div>
              <Form>
                <FormControl
                  type="text"
                  placeholder="Search for major subject..."
                />
              </Form>
            </div>
          </div>
            ...
            <Table striped bordered hover>
              <thead>
                <tr>
                  ...
                  <th >
                    <FormControl type="text" placeholder="major subjects" />
                  </th>
                  <th className="col-2">
                    <Form.Select aria-label="Default select example">
...
export default Listmajorsubjects;
