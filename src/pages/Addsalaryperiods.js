...
function Addsalaryperiods() {
  return (
    <>
      <div className="Tabs_container">
        <div className="Tabs_content text-start p-4">
          <h4>Add New salary periods</h4>
          <Form className="Adminuser_form col-8 py-4">
            ...
            <label className="fs-6">salary-periods:</label>
            <FormControl type="text" placeholder="salary-periods"  className="py-2 mb-3"/>
...
export default Addsalaryperiods;
