...
const Listlanguagelevel = () => {
  const navigate = useNavigate();
  const navigateTolanguagelevel = () => {
    navigate("/Addlanguagelevel");
  };
          ...
          <div className="Tabs_header d-flex justify-content-between py-4">
            ...
            <div>
              <Form>
                <FormControl
                  type="text"
                  placeholder="Search for Langauge level..."
                />
              </Form>
            </div>
          </div>
            ...
            <Table striped bordered hover>
              <thead>
                <tr>
                  ...
                  <th >
                  <FormControl type="text" placeholder="Language-level" />
                  </th>
                  <th className="col-2">
                    <Form.Select aria-label="Default select example">
...
export default Listlanguagelevel;
